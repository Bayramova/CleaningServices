            ...
            <Form>
              ...
              <Form.Item label="Type of cleaning">
                {getFieldDecorator("serviceType", {
                  initialValue: props.serviceType.value,
                  rules: [
                    {
                      required: true,
              ...
              <Form.Item label="Number of big rooms (> 30 sq m)">
                {getFieldDecorator("bigRooms", {
                  initialValue: props.bigRooms.value,
                  rules: [
                    {
                      required: true,
              ...
              <Form.Item label="Number of small rooms">
                {getFieldDecorator("smallRooms", {
                  initialValue: props.smallRooms.value,
                  rules: [
                    {
                      required: true,
                      message: "Please input number of rooms!"
              ...
              <Form.Item label="Number of bathrooms">
                {getFieldDecorator("bathrooms", {
                  initialValue: props.bathrooms.value,
                  rules: [
                    {
                      required: true,
                      message: "Please input number of rooms!"
              ...
              <Form.Item label="Day/Days">
                {getFieldDecorator("daysOfCleaning", {
                  initialValue: props.daysOfCleaning.value,
                  rules: [
                    {
                      required: true,
              ...
              <Form.Item label="Expected start time of cleaning">
                {getFieldDecorator("startTimeOfCleaning", {
                  initialValue: props.startTimeOfCleaning.value,
                  rules: [
                    {
                      required: true,
              ...
              <Form.Item label="Cleaning frequency">
                {getFieldDecorator("cleaningFrequency", {
                  initialValue: props.cleaningFrequency.value,
                  rules: [
                    {
                      required: true,
              ...
              <Form.Item label="Phone Number">
                {getFieldDecorator("phone", {
                  initialValue: props.phone.value,
                  rules: [
                    {
                      required: true,
              ...
              <Form.Item>
                <Link
                  to={`/service/${props.serviceType.value}`}
                  onClick={handleClick}
                >
